...
<body>
    ...
    <div style="width: 100%; text-align: left; margin-top: 0.5cm; border: 2px solid grey;">
        <div style="width: 20%; padding-left: 15px; border-right: 3px solid grey">
            ...
            <div style="padding-bottom: 10px; font-size: 12px;">@if ($filters['division'] > 0) {{ $filters['division']}}
            @else Todas @endif</div>
        </div>

        <div style="width: 20%; padding-left: 15px; border-right: 3px solid grey">
            <div style="font-weight:bolder; font-size: 16px;">Roles</div>
            <div style="padding-bottom: 10px; font-size: 12px;">@if ($filters['rol'] > 0) {{ $filters['rol']}} @else
            Todos @endif</div>
        </div>
        <div style="width: 20%; padding-left: 15px; border-right: 3px solid grey">
            <div style="font-weight:bolder; font-size: 16px;">Persona</div>
            <div style="padding-bottom: 10px; font-size: 12px;">@if ($filters['person'] > 0) {{ $filters['person']}}
            @else Todos @endif</div>
        </div>
