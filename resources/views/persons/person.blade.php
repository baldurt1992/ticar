...
@section('content')
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group m-t-10">
                                ...
                                <div class="input-group">
                                    <input type="text" id="example-input2-group2" name="example-input2-group2"
                                        class="form-control" v-model="item.token">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-7">
                        ...
                        <div class="col-lg-3">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="date" id="example-input2-group2" name="example-input2-group2"
                                        class="form-control" v-model="item.created_at">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 mt-4">
                            <div class="custom-control custom-checkbox mb-1">
                                <input type="checkbox" class="custom-control-input" v-model="item.status_id"
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div v-for="divi in divisions" class="col-lg-12 mt-4">
                                    <div class="custom-control custom-checkbox mb-1">
                                        <input type="checkbox" class="custom-control-input" :value="divi . id"
                                            v-model="persons.divisions" :id="divi . id">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div v-for="rl in rols" class="col-lg-12 mt-4">
                                    <div class="custom-control custom-checkbox mb-1">
                                        <input type="checkbox" class="custom-control-input" :value="rl . id"
                                            v-model="persons.rols" :id="'r' + rl . id">
    ...
    <div v-if="views.list" class="row ">
        <div class="col-lg-12 overflow-persons">
            <div class="card card-small mb-4 overflow-persons">
                        ...
                        <tbody>
                            <tr v-for="entity in lists" class="mouse">
                                ...
                                <td class="d-flex" style="gap: 2px;">
                                    <button class="btn btn-success btn-sm" @click="edit(entity)"><i
                                            class="fa fa-edit"></i></button>
                                    <button class="btn btn-danger btn-sm" @click="showdelete(entity)"><i
                                            class="fa fa-eraser"></i></button>
                                    <button class="btn btn-info btn-sm" @click="getdata(entity)"><i
